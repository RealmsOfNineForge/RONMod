...
public class RootInfusedStoneFeature extends OreFeature {
	public static RootInfusedStoneFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new RootInfusedStoneFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("realms_of_nine:root_infused_stone", FEATURE,
				new OreConfiguration(List.of(
						OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()),
								RealmsOfNineModBlocks.ROOT_INFUSED_STONE.get().defaultBlockState()),
						...
						OreConfiguration.target(new BlockStateMatchTest(Blocks.ANDESITE.defaultBlockState()),
								RealmsOfNineModBlocks.ROOT_INFUSED_STONE.get().defaultBlockState())),
						16));
		PLACED_FEATURE = PlacementUtils.register("realms_of_nine:root_infused_stone", CONFIGURED_FEATURE,
