...
public class AlfcrystalOreFeature extends OreFeature {
	public static AlfcrystalOreFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new AlfcrystalOreFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("realms_of_nine:alfcrystal_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()),
						RealmsOfNineModBlocks.ALFCRYSTAL_ORE.get().defaultBlockState())), 7));
		PLACED_FEATURE = PlacementUtils.register("realms_of_nine:alfcrystal_ore", CONFIGURED_FEATURE,
