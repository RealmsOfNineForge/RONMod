...
public class SteelOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("realms_of_nine:steel_ore", FEATURE, new OreConfiguration(List.of(OreConfiguration
				.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()), RealmsOfNineModBlocks.STEEL_ORE.get().defaultBlockState())), 14));
		PLACED_FEATURE = PlacementUtils.register("realms_of_nine:steel_ore", CONFIGURED_FEATURE,
