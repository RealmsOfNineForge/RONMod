...
public class Tier2GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Tier2GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RealmsOfNineModMenus.TIER_2_GUI.get(), id);
		...
		this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 7, 38) {
		}));
		this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 25, 38) {
		}));
		this.customSlots.put(11, this.addSlot(new SlotItemHandler(internal, 11, 43, 38) {
		}));
		this.customSlots.put(12, this.addSlot(new SlotItemHandler(internal, 12, 61, 38) {
		}));
		this.customSlots.put(13, this.addSlot(new SlotItemHandler(internal, 13, 79, 38) {
		}));
		...
		this.customSlots.put(18, this.addSlot(new SlotItemHandler(internal, 18, 7, 56) {
		}));
		this.customSlots.put(19, this.addSlot(new SlotItemHandler(internal, 19, 25, 56) {
		}));
		this.customSlots.put(20, this.addSlot(new SlotItemHandler(internal, 20, 43, 56) {
		}));
