...
public class Tier1GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Tier1GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RealmsOfNineModMenus.TIER_1_GUI.get(), id);
