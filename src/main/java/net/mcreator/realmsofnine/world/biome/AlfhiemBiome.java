...
public class AlfhiemBiome {
	public static final Climate.ParameterPoint PARAMETER_POINT = new Climate.ParameterPoint(Climate.Parameter.span(-0.3f, 0.033333333334f),
			...
			Climate.Parameter.span(-0.686238202103f, -0.352904868769f), 0);

	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(12638463).waterColor(4159204).waterFogColor(329011).skyColor(7972607)
				.foliageColorOverride(10387789).grassColorOverride(-16737997)
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("realms_of_nine:tree_alfhiem",
				FeatureUtils.register("realms_of_nine:tree_alfhiem", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
						BlockStateProvider.simple(RealmsOfNineModBlocks.HAWTHORN_LOG.get().defaultBlockState()), new GiantTrunkPlacer(7, 2, 14),
						BlockStateProvider.simple(RealmsOfNineModBlocks.HAWTHORN_LEAVES.get().defaultBlockState()),
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("realms_of_nine:grass_alfhiem", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("realms_of_nine:flower_alfhiem", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(5),
