...
public abstract class AlfcrystalArmorItem extends ArmorItem {
	public AlfcrystalArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends AlfcrystalArmorItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "realms_of_nine:textures/models/armor/alfcrystal__layer_1.png";
		}
	}

	public static class Chestplate extends AlfcrystalArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends AlfcrystalArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "realms_of_nine:textures/models/armor/alfcrystal__layer_2.png";
		}
	}

	public static class Boots extends AlfcrystalArmorItem {
		public Boots() {
