...
import net.mcreator.realmsofnine.world.biome.SvartelheimMinesBiome;
import net.mcreator.realmsofnine.world.biome.MidgardBiomeBiome;
import net.mcreator.realmsofnine.world.biome.AlfhiemBiome;
...
public class RealmsOfNineModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, RealmsOfNineMod.MODID);
	public static final RegistryObject<Biome> MIDGARD = REGISTRY.register("midgard", MidgardBiomeBiome::createBiome);
	public static final RegistryObject<Biome> SVARTELHEIM_MINES = REGISTRY.register("svartelheim_mines", SvartelheimMinesBiome::createBiome);
	public static final RegistryObject<Biome> ALFHIEM = REGISTRY.register("alfhiem", AlfhiemBiome::createBiome);
