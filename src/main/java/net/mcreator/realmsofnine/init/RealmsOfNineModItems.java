...
import net.mcreator.realmsofnine.item.WroughtIronHammerItem;
...
import net.mcreator.realmsofnine.item.ShardsSwordItem;
import net.mcreator.realmsofnine.item.ShardsShovelItem;
import net.mcreator.realmsofnine.item.ShardsPickaxeItem;
import net.mcreator.realmsofnine.item.ShardsOfSurtursBladeItem;
import net.mcreator.realmsofnine.item.ShardsHoeItem;
import net.mcreator.realmsofnine.item.ShardsAxeItem;
import net.mcreator.realmsofnine.item.ShardsArmorItem;
...
public class RealmsOfNineModItems {
	...
	public static final RegistryObject<Item> HAWTHORN_WOOD = block(RealmsOfNineModBlocks.HAWTHORN_WOOD, RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	public static final RegistryObject<Item> HAWTHORN_LOG = block(RealmsOfNineModBlocks.HAWTHORN_LOG, RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	public static final RegistryObject<Item> HAWTHORN_PLANKS = block(RealmsOfNineModBlocks.HAWTHORN_PLANKS, RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	public static final RegistryObject<Item> HAWTHORN_LEAVES = block(RealmsOfNineModBlocks.HAWTHORN_LEAVES, RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	...
	public static final RegistryObject<Item> SUPERIOR_VANA_CRYSTAL_BLOCK = block(RealmsOfNineModBlocks.SUPERIOR_VANA_CRYSTAL_BLOCK,
			RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	public static final RegistryObject<Item> SHARDS_OF_BLADE_ORE = block(RealmsOfNineModBlocks.SHARDS_OF_BLADE_ORE,
			RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	...
	public static final RegistryObject<Item> HAWTHORN_STAIRS = block(RealmsOfNineModBlocks.HAWTHORN_STAIRS, RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	public static final RegistryObject<Item> HAWTHORN_SLAB = block(RealmsOfNineModBlocks.HAWTHORN_SLAB, RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	public static final RegistryObject<Item> HAWTHORN_FENCE = block(RealmsOfNineModBlocks.HAWTHORN_FENCE, RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	public static final RegistryObject<Item> HAWTHORN_FENCE_GATE = block(RealmsOfNineModBlocks.HAWTHORN_FENCE_GATE,
			RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	public static final RegistryObject<Item> HAWTHORN_PRESSURE_PLATE = block(RealmsOfNineModBlocks.HAWTHORN_PRESSURE_PLATE,
			RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	public static final RegistryObject<Item> HAWTHORN_BUTTON = block(RealmsOfNineModBlocks.HAWTHORN_BUTTON, RealmsOfNineModTabs.TAB_RISE_OF_THE_NINE);
	...
	public static final RegistryObject<Item> SHARDS_OF_SURTURS_BLADE = REGISTRY.register("shards_of_surturs_blade",
			() -> new ShardsOfSurtursBladeItem());
	...
	public static final RegistryObject<Item> WROUGHT_IRON_HAMMER = REGISTRY.register("wrought_iron_hammer", () -> new WroughtIronHammerItem());
	...
	public static final RegistryObject<Item> SHARDS_PICKAXE = REGISTRY.register("shards_pickaxe", () -> new ShardsPickaxeItem());
	public static final RegistryObject<Item> SHARDS_AXE = REGISTRY.register("shards_axe", () -> new ShardsAxeItem());
	public static final RegistryObject<Item> SHARDS_SHOVEL = REGISTRY.register("shards_shovel", () -> new ShardsShovelItem());
	public static final RegistryObject<Item> SHARDS_HOE = REGISTRY.register("shards_hoe", () -> new ShardsHoeItem());
	...
	public static final RegistryObject<Item> SHARDS_SWORD = REGISTRY.register("shards_sword", () -> new ShardsSwordItem());
	...
	public static final RegistryObject<Item> SHARDS_ARMOR_HELMET = REGISTRY.register("shards_armor_helmet", () -> new ShardsArmorItem.Helmet());
	public static final RegistryObject<Item> SHARDS_ARMOR_CHESTPLATE = REGISTRY.register("shards_armor_chestplate",
			() -> new ShardsArmorItem.Chestplate());
	public static final RegistryObject<Item> SHARDS_ARMOR_LEGGINGS = REGISTRY.register("shards_armor_leggings", () -> new ShardsArmorItem.Leggings());
	public static final RegistryObject<Item> SHARDS_ARMOR_BOOTS = REGISTRY.register("shards_armor_boots", () -> new ShardsArmorItem.Boots());
